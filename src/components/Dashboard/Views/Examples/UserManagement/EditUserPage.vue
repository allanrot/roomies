      ...
      <form @submit.prevent>
       <div class="form-group">
        ...
        <validation-error :errors="apiValidationErrors.email" />
         ...
         <el-select
            class="select-default" placeholder="Roles" v-model="user.roles[0].id">
            <el-option
        ...
        <fg-input v-model="user.password" placeholder="Password" label="Password" type="password"></fg-input>
        <validation-error :errors="apiValidationErrors.password" />
        <fg-input v-model="user.password_confirmation" placeholder="Confirm password" label="Confirm password" type="password"></fg-input>
